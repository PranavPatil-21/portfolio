...
export const proseClassName = [
  ...
  '[&_p]:text-pretty',
  '[&_a]:font-medium [&_a]:text-[color:var(--accent)] [&_a]:underline [&_a]:underline-offset-4 [&_a]:decoration-[color:var(--accent)]/40 hover:[&_a]:decoration-[color:var(--accent)]',
  ...
  '[&_li::marker]:text-[color:var(--accent)]/70',
