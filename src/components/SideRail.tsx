...
export default function SideRail({
  ...
  return (
    <header className="min-w-0 lg:sticky lg:top-[3.5rem] lg:flex lg:max-h-[calc(100vh-3.5rem)] lg:flex-col lg:justify-between lg:pt-10 lg:pr-12 lg:pb-16 lg:pl-10 xl:pl-16">
      <div>
        {roles[0] ? (
